          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={saving}
                className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/15 text-white flex items-center gap-2 transition-all border border-white/20"
              >
              ...
              <button
                ...
                disabled={saving}
                className="px-6 py-2 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold flex items-center gap-2 transition-all hover:shadow-lg hover:shadow-amber-500/30"
              >
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative" ref={templateMenuRef}>
              <button
                ...
                className="px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white/70 hover:text-white flex items-center gap-2 transition-all border border-white/10"
              >
              ...
              {showTemplateMenu && (
                <div className="absolute top-full left-0 mt-2 w-48 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl overflow-hidden z-50">
            ...
            <label className={toolbarBtn() + ' cursor-pointer'} title="上传图片">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="输入标签..."
                  className="flex-1 px-4 py-2 rounded-lg bg-white/5 border border-white/20 text-white placeholder-white/30 focus:border-amber-400/50 focus:outline-none transition-all"
                />
                <button
                  onClick={handleAddTag}
                  className="px-4 py-2 rounded-lg bg-amber-500/20 text-amber-400 border border-amber-400/30 hover:bg-amber-500/30 transition-all"
                >
                  添加
                </button>
              </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/5 border border-white/20 text-white placeholder-white/30 focus:border-amber-400/50 focus:outline-none transition-all"
              />
            </div>
          </div>
        </GlassCard>
