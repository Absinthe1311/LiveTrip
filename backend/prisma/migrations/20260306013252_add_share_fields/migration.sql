...
INSERT INTO "new_Trip" ("actualBudget", "aiGenerated", "budgetStatus", "createdAt", "description", "destination", "endDate", "hotelAddress", "hotelLocation", "hotelName", "hotelRating", "hotelTel", "hotelType", "id", "startDate", "status", "title", "totalBudget", "updatedAt", "userId") SELECT "actualBudget", "aiGenerated", "budgetStatus", "createdAt", "description", "destination", "endDate", "hotelAddress", "hotelLocation", "hotelName", "hotelRating", "hotelTel", "hotelType", "id", "startDate", "status", "title", "totalBudget", "updatedAt", "userId" FROM "Trip";
DROP TABLE "Trip";
