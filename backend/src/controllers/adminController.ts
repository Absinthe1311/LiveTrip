...
export class AdminController {
  static async getDashboardStats(req: Request, res: Response): Promise<void> {const stats = await Promise.all([
    prisma.spot.count(),
...
static async getSpotImageStatus(req: Request, res: Response): Promise<void> {
  ...
  static async reviewImage(req: Request, res: Response): Promise<void> {
    ...
    const updated = await prisma.spotImage.update({
      where: { id: imageIdStr },
      data: {
        status,
